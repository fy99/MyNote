...
git reset --hard [log中的hash] 
1. --hard: repo=> work
2. --soft :	repo=>stag
3. --mix  : repo=>work_header
...
原文链接：[https://blog.csdn.net/weixin_40295575/article/details/91816937](https://blog.csdn.net/weixin_40295575/article/details/91816937)
...
1. git stash save ‘说明信息’   // 暂存代码，并添加说明
2. git stash list    // 查看stash列表
3. git stash apply  // 取出最近一次的stash
4. git stash apply 数字  // 输入list里对应的数字，取出对应的stash
5. git stash --all  // 暂存所有文件，包括没有被git追踪的文件
